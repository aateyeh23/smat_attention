"""Continue completed 750M PG19 training states to 1B at constant learning rate."""
import argparse
...
def train(args):
    ...
    if resume_path.exists():
        ...
        elif saved['cursor']*cfg.length != 750010368 or not saved['complete']:
            raise ValueError('Expected completed 750M resumable checkpoint')
