...
PARENT = REPO / 'deltaai/results/learned_mkar_original_mamba_transport_normalized_stop_20260923'
RULE = REPO / 'deltaai/results/mkar_iteration_20260923/normalized_stop_selection_rule.json'
