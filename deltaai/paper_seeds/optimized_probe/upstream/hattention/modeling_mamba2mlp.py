...
from hattention.configuration_mamba2mlp import Mamba2MLPConfig as Mamba2Config
from paper_legacy_fla.modules import FusedCrossEntropyLoss, FusedLinearCrossEntropyLoss, RMSNorm, GatedMLP
from paper_legacy_fla.modules.layernorm_gated import RMSNormGated
...
class Mamba2PreTrainedModel(PreTrainedModel, GenerationMixin):
    ...
    def _init_weights(
        self,
        module: nn.Module,
        num_residuals_per_layer: int = 2,  # Mamba2 + MLP
    ):
