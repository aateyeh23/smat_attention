...
def check_routed_operator():
    ...
    mask=incidence[ri[:,:,:,None],wi[:,None,None,:,0]]
    routing=(mask*rw[...,None]).sum(2)*ww[:,None,:,0]
    ...
    inputs=(u,q,k,v,beta,g,ca.W,ca.W_read,ca.b_read)
    ...
    print('PASS routed operator: exact four-read masked temporal kernel and routing/feature gradients',flush=True)
...
if __name__=='__main__':
    ...
    check_transport();check_routed_operator();check_mixer()
