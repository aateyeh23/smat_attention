...
modal run --detach deltaai/modal_mqar_four_reads.py::sweep
"""
import json
import os
...
image = (
    ...
    .env({'PYTHONPATH': '/opt/smat/deltaai:/opt/smat/smat:/opt/zoology:/opt/fla-source',
          'FLA_TILELANG': '0', 'TRITON_F32_DEFAULT': 'tf32x3', 'WANDB_MODE': 'disabled',
          'OMP_NUM_THREADS': '2', 'MKL_NUM_THREADS': '2',
          'PYTORCH_CUDA_ALLOC_CONF': 'expandable_segments:True',
          'MQAR_FOUR_READS_DIR': str(RUN)})
    .add_local_dir(BUNDLE / 'deltaai', str(REMOTE))
