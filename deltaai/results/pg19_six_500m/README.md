...
Active Modal app: [ap-hpwI1brPNCjWfs3nvgW2VP](https://modal.com/apps/archerdwang/main/ap-hpwI1brPNCjWfs3nvgW2VP).
Optimized GDN continuation app: [ap-IeUwYiy5yeh7EdOo5GJEWm](https://modal.com/apps/archerdwang/main/ap-IeUwYiy5yeh7EdOo5GJEWm).
...
```bash
modal run --detach deltaai/modal_pg19_six.py::sweep
python deltaai/collect_pg19_six.py --watch
```
