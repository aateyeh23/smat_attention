...
from paper_legacy_fla.ops.common.chunk_delta_h import prepare_chunk_offsets
from paper_legacy_fla.ops.generalized_delta_rule.iplr.wy_fast import fwd_prepare_wy_repr
