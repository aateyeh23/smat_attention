...
| GDN (current transport) | 4 | 1 | 45.98 | 3.61 | 36.59 | 39,592 |
| GDN (current transport) | 8 | 1 | 10.49 | 0.00 | 0.13 | 39,592 |
| GDN (current transport) | 16 | 1 | 6.83 | 0.00 | -0.01 | 39,592 |
...
| GDN (current transport) + SMat d=2 | 4 | 1 | 82.62 | 42.55 | 72.55 | 46,548 |
| GDN (current transport) + SMat d=2 | 8 | 1 | 10.63 | 0.00 | -0.01 | 47,588 |
| GDN (current transport) + SMat d=2 | 16 | 1 | 6.56 | 0.00 | 0.21 | 48,108 |
...
| GDN (current transport) + SMat d=3 | 4 | 1 | 83.59 | 45.31 | 74.09 | 54,328 |
| GDN (current transport) + SMat d=3 | 8 | 1 | 6.59 | 0.00 | -0.08 | 54,328 |
| GDN (current transport) + SMat d=3 | 16 | 1 | 6.32 | 0.00 | -0.12 | 61,600 |
...
| GDN (current transport) + SMat d=4 | 4 | 1 | 85.44 | 51.37 | 76.64 | 58,724 |
| GDN (current transport) + SMat d=4 | 8 | 1 | 7.97 | 0.00 | -0.01 | 58,724 |
| GDN (current transport) + SMat d=4 | 16 | 1 | 6.46 | 0.00 | 0.17 | 93,492 |
...
| GDN (current transport) | 2 | 1 | 33.06 | 33.06 | -1.59 | 55,976 |
| GDN (current transport) | 4 | 1 | 6.62 | 6.62 | 0.10 | 55,976 |
| GDN (current transport) | 8 | 1 | 5.93 | 5.93 | -0.20 | 55,976 |
...
| GDN (current transport) + SMat d=2 | 2 | 1 | 13.96 | 13.96 | 0.90 | 62,932 |
| GDN (current transport) + SMat d=2 | 4 | 1 | 6.32 | 6.32 | 0.12 | 62,932 |
| GDN (current transport) + SMat d=2 | 8 | 1 | 5.32 | 5.32 | -0.87 | 63,972 |
...
| GDN (current transport) + SMat d=3 | 2 | 1 | 25.44 | 25.44 | 0.34 | 70,712 |
| GDN (current transport) + SMat d=3 | 4 | 1 | 6.15 | 6.15 | 0.20 | 70,712 |
| GDN (current transport) + SMat d=3 | 8 | 1 | 5.47 | 5.47 | -0.74 | 70,712 |
...
| GDN (current transport) + SMat d=4 | 2 | 1 | 6.64 | 6.64 | 0.46 | 75,108 |
| GDN (current transport) + SMat d=4 | 4 | 1 | 6.32 | 6.32 | 0.01 | 75,108 |
| GDN (current transport) + SMat d=4 | 8 | 1 | 5.37 | 5.37 | -0.86 | 75,108 |
...
| Mamba-2 | 8 | 1 | 5.35 | 5.35 | -0.86 | 90,864 |
...
| Mamba-2 + SMat d=2 | 8 | 1 | 5.35 | 5.35 | -0.86 | 105,456 |
...
| Mamba-2 + SMat d=3 | 8 | 1 | 5.35 | 5.35 | -0.86 | 132,416 |
...
| Mamba-2 + SMat d=4 | 2 | 1 | 26.51 | 26.51 | -0.54 | 150,000 |
| Mamba-2 + SMat d=4 | 4 | 1 | 12.72 | 12.72 | -0.90 | 150,000 |
| Mamba-2 + SMat d=4 | 8 | 1 | 5.35 | 5.35 | -0.86 | 150,000 |
