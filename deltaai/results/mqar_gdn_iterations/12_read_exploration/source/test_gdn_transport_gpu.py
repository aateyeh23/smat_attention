...
def check_routed_operator(neighbor_grad=False, symmetric_write_grad=False):
    ...
    print(f'PASS routed operator: four-read dense reference; neighbor_write_grad={neighbor_grad}; symmetric_write_grad={symmetric_write_grad}',flush=True)
