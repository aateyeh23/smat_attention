...
def check_routed_operator(neighbor_grad=False, symmetric_write_grad=False, periodic_hash=False):
    ...
    ca.symmetric_write_grad=symmetric_write_grad
    ca.periodic_hash=periodic_hash
    ...
    print(f'PASS routed operator: four-read dense reference; neighbor_write_grad={neighbor_grad}; symmetric_write_grad={symmetric_write_grad}; periodic_hash={periodic_hash}',flush=True)
