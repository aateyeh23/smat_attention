...
m=SmatGDNTransport(32,d=int(os.environ.get('ZOO_DS', '3')),headdim=16,n_heads=2,expand_v=1,memory_update='delta',
...
print(f'PASS model geometry width=32 d={m.d} heads=2 head/state=16',flush=True)
if m.profile_delta:
...
if m.memory_read_noise:
    ...
    m(torch.randn(2,64,32,device='cuda'))
