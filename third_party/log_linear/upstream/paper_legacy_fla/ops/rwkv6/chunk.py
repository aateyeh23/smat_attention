...
from paper_legacy_fla.ops.common.chunk_h import chunk_fwd_h
from paper_legacy_fla.ops.gla.chunk import chunk_gla_bwd_dA, chunk_gla_bwd_dv, chunk_gla_fwd_o_gk
from paper_legacy_fla.ops.utils.op import exp
from paper_legacy_fla.utils import autocast_custom_bwd, autocast_custom_fwd, check_shared_mem, input_guard, use_cuda_graph
...
def chunk_rwkv6(
    ...
    Examples::
        ...
        >>> from paper_legacy_fla.ops.rwkv6 import chunk_rwkv6
