...
sweep_name = "011026-data=simple_stacked_mqar-loss=mse-sweep-v4" + sweep_id
...
test_configs = [
    ...
    MQARConfig(num_examples=1_000, num_kv_pairs=48),
    MQARConfig(num_examples=1_000, num_kv_pairs=64),
    MQARConfig(num_examples=1_000, num_kv_pairs=80),
    MQARConfig(num_examples=1_000, num_kv_pairs=96),
    MQARConfig(num_examples=1_000, num_kv_pairs=112),
    MQARConfig(num_examples=1_000, num_kv_pairs=128),
    MQARConfig(num_examples=1_000, num_kv_pairs=144),
    MQARConfig(num_examples=1_000, num_kv_pairs=160),
    MQARConfig(num_examples=1_000, num_kv_pairs=176),
    MQARConfig(num_examples=1_000, num_kv_pairs=192),
    MQARConfig(num_examples=1_000, num_kv_pairs=208),
    MQARConfig(num_examples=1_000, num_kv_pairs=224),
    MQARConfig(num_examples=1_000, num_kv_pairs=240),
    MQARConfig(num_examples=1_000, num_kv_pairs=256),
    MQARConfig(num_examples=1_000, num_kv_pairs=272),
    MQARConfig(num_examples=1_000, num_kv_pairs=288),
    MQARConfig(num_examples=1_000, num_kv_pairs=304),
    MQARConfig(num_examples=1_000, num_kv_pairs=320),
    MQARConfig(num_examples=1_000, num_kv_pairs=336),
    MQARConfig(num_examples=1_000, num_kv_pairs=352),
    MQARConfig(num_examples=1_000, num_kv_pairs=368),
    MQARConfig(num_examples=1_000, num_kv_pairs=384),
]
