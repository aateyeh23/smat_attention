# Tables 2–3: additional training seeds on the GPU cluster
...
- All training executes on the GPU cluster GH200 GPUs. Historical Modal artifacts are
...
runs. Completed the second cluster results were found in remote commit
...
Run `python paper_seeds/collect.py` from the repository root to refresh
